...
class AddCashierActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.addUserTitle.text = "Add Cashier"
        ...
        binding.addUserButton.setOnClickListener {
            ...
            if (validateInputs(username, password, confirmPassword)) {
                ...
                if (!isCashierUsernameExists(username)) {
                    // Create user in the database
                    dbHandler.registerCashier(username, password)
                    Toast.makeText(this, "Cashier user $username created successfully!", Toast.LENGTH_SHORT).show()
                } else {
                    Toast.makeText(this, "Username is already registered as Cashier.", Toast.LENGTH_SHORT).show()
                }
            }
        }
    }
    ...
    fun isCashierUsernameExists(username: String): Boolean {
        ...
        return dbHandler.isCashierUsernameExists(username)
    }
}